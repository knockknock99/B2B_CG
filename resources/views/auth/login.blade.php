  ...
  <div class="container main-container">
      ...
      <div id="serviceCarousel" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="{{asset('asset/img/gatewy2.png')}}" class="d-block w-100" alt="Micro ATM">
          </div>
          <div class="carousel-item">
            <img src="{{asset('asset/img/gatewy2.png')}}" class="d-block w-100" alt="Money Transfer">
          </div>
          <div class="carousel-item">
            <img src="{{asset('asset/img/gatewy1.png')}}" class="d-block w-100" alt="Insurance">
          </div>
        </div>
    ...
    <div class="form-container">
      <div class="form-section">
        ...
        @endif
        <!-- Login Form -->
        <img src="{{asset('asset/img/compnylogo.jpg')}}" alt="Logo">
        <form action="{{ route('user.auhtentication') }}" method="POST">
          ...
          <div class="d-flex justify-content-between align-items-center">
            <a href="{{route('user.frogetvew')}}" class="text-decoration-none">Forgot Password?</a>
          </div>
