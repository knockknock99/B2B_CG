    ...
    <nav class="mt-3 ">
      <a href="{{route('user.dashboard')}}" class="flex items-center px-4 py-4   font-medium text-blue-900 hover:text-white hover:bg-blue-900  rounded-l-3xl">
        <span class="mr-3 opacity-3">
          <img src="{{asset('asset/img/home1.png')}}" width="23px" height="23px" alt="home">
      ...
      <div class="relative">
        ...
        <a href="{{route('user.service')}}" 
           ...
           >
          <span class="mr-3">
            <img src="{{asset('asset/img/services2.png')}}" width="25px" height="25px" alt="">
          </span>
          <span>Services</span>
          <span class="ml-2"  id="service-report-btn2" >
            <svg id="arrow-icon2" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 transform transition-transform" viewBox="0 0 20 20" fill="currentColor">
              <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06-.02L10 10.654l3.71-3.464a.75.75 0 011.02 1.09l-4 3.75a.75.75 0 01-1.04 0l-4-3.75a.75.75 0 01-.02-1.06z" clip-rule="evenodd" />
            </svg>
          </span>
        </a>
        ...
        <div id="dropdown-menu2" class="relative left-8  w-48 hidden">
          <a href="{{route('user.mobile_recharge_service')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">Mobile Recharge</a>
          <a href="{{route('user.dth_service')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">Dth Recharge</a>
          <a href="{{route('user.bill_payment_service')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">Bill Payment</a>
          <a href="{{route('user.aeps_service')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">Aeps</a>
          <a href="{{route('user.money_transfer_service')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">Money Transfer</a>
          {{-- <a href="{{route('user.tds')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">Payout</a> --}}
          <a href="{{route('user.fund_request_service')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">Fund Request</a>
          <a href="{{route('user.addharpay')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">Aadhar Pay</a>
        </div>
      </div>

      <script>
        document.addEventListener('DOMContentLoaded', () => {
          const button = document.getElementById('service-report-btn2');
          const dropdown = document.getElementById('dropdown-menu2');
          const arrowIcon = document.getElementById('arrow-icon2');
      ...
      <div class="relative">
        ...
        <div id="dropdown-menu" class="relative left-8  w-48 hidden">
          <a href="{{route('user.money_transfer_report')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">Mobile Recharge</a>
      ...
      <a href="{{route('user.account_histry')}}" class="flex items-center px-4 py-4 text-blue-900 font-medium  text-['#000b55'] hover:bg-blue-900 hover:text-white rounded-l-3xl ">
        <span class="mr-3">
            <img src="{{asset('asset/img/file.png')}}" width="27px" height="27px" alt="">
      ...
      <a href="{{route('user.commission_slab')}}" class="flex items-center px-4 py-4 text-blue-900 font-medium  text-['#000b55'] hover:bg-blue-900 hover:text-white rounded-l-3xl ">
        <span class="mr-3">
            <img src="{{asset('asset/img/commission.png')}}" width="27px" height="27px"  alt="home">
      ...
      <a href="{{route('user.gstreport')}}" class="flex items-center px-4 py-4 text-blue-900 font-medium  text-['#000b55'] hover:bg-blue-900 hover:text-white rounded-l-3xl ">
        <span class="mr-3">
            <img src="{{asset('asset/img/gst.png')}}" width="27px" height="27px" alt="">
      ...
      <a href="{{route('user.tds')}}" class="flex items-center px-4 py-4 text-blue-900 font-medium  text-['#000b55'] hover:bg-blue-900 hover:text-white rounded-l-3xl ">
        <span class="mr-3">
            <img src="{{asset('asset/img/tds.png')}}" width="28px" height="28px" alt="">
      ...
      <a href="{{route('user.commissionReport')}}" class="flex items-center px-4 py-4 text-blue-900 font-medium  text-['#000b55'] hover:bg-blue-900 hover:text-white rounded-l-3xl ">
        <span class="mr-3">
            <img src="{{asset('asset/img/commission_report.png')}}" width="27px" height="27px" alt="">
      ...
      <div class="relative">
        ...
        <a href="#" 
          ...
          <span class="mr-3">
            <img src="{{asset('asset/img/setting.png')}}" width="27px" height="27px" alt="">
          </span>
    ...
    {{-- <div class="flex-1 ml-0 md:ml-64"> --}}
        <header class="bg-blue-900 text-white p-1.5 lg:p-3 ml-3 flex justify-between items-center sticky top-0 z-10 rounded-xl ml-1.5 mr-1.5">
          ...
          <div class="flex space-x-3">
            <div class="rounded-lg px-2 lg:px-4 lg:py-2 ml-1  text-white flex items-center  sm:py-1 ">
              {{-- <h1 class="text-sm font-bold"></h1> --}}
              <span class=" font-normal text-xs lg:text-md lg:font-bold lg:text-lg">₹ 200000.00</span>
            </div>

            <a href="{{route('user.addbialance')}}">
            <div class="rounded-lg  px-2 lg:px-5  py-2 text-white flex items-center justify-center ">
            <img src=" {{asset('asset/img/plus-2.png')}}" width="20px" height="20px" class="mr-1 " alt="">  
            ...
            <div class="rounded-lg px-4 py-2  text-white flex items-center  ">
              <h1 class="text-sm font-normal lg:text-md lg:font-bold  lg:text-lg"><span class="text-white ">KYC Status: </span>Verified </h1>
              {{-- <span class="text-sm font-bold">₹ 0</span> --}}
              <img src="{{asset('asset/img/tick3.png')}}" width="15px" height="15px" class="mr-2 ml-1" alt="">
            </div>
          ...
          <div class="flex justify-center align-center ">
            ...
            <div class="mb mr-4">
              ...
              <h3 class="font-bold text-bold">Welcome, Iftekhar
                {{-- {{Auth::user()->name}} --}}
              </h3>
            </div>
            ...
            <button class="w-8 h-8 rounded-full bg-gray-100 text-blue-900 flex items-center justify-center  lg:mr-5" id="avatarButton">
              ...
              {{-- <img  --}}
              {{-- src="{{ $kycData->frontpic ? asset('storage/' . $kycData->frontpic) : asset('asset/img/profilelogo.png') }}"  --}}
              {{-- alt="Front-Facing Picture"  --}}
              {{-- class= "w-8 h-8 overflow-hidden rounded-full" id="profile-pic"> --}}
                
             
              <img src="{{ asset('asset/img/profilelogo.png') }}" alt="Front Image" id="profile-pic" class= "w-8 h-8 overflow-hidden rounded-full" id="profile-pic">
            ...
            <div id="dropdownMenu" class="absolute right-0 mt-2 mr-5 w-40 bg-white border rounded-lg shadow-lg flex flex-col align-center hidden">
              <a href="{{route('user.my_profile')}}" class="block px-4 py-2 text-medium text-blue-900 hover:bg-gray-200 rounded-lg">MY Profile</a>
              <a href="{{route('user.certificate')}}" class="block px-4 py-2 text-medium text-blue-900 hover:bg-gray-200 rounded-lg">Certificate</a>
              ...
              <a href="{{route('admin.admin_dashboard')}}" class="block px-4 py-2 text-medium text-blue-900 hover:bg-gray-200 rounded-lg">Admin</a>
              <a href="{{route('user.logout1')}}" class="block px-4 py-2 text-medium text-blue-900 hover:bg-gray-200 rounded-lg">Log out</a>
            </div>
          </div>
        </header>
...
{{-- chart js start --}}
<script src="{{asset('css/dashboard.js')}}"></script> <!-- Link to your JavaScript file -->
