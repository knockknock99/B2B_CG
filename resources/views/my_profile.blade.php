...
<form action="" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="flex justify-center pt-10 pb-3 relative">
        <label for="profile-pic-upload" class="cursor-pointer relative">
            <img src="{{ asset('asset/img/profilelogo.png') }}" alt="Front Image" id="profile-pic" class= "w-32 h-32 overflow-hidden rounded-full">
...
<div class="text-center px-6 py-4  flex-col justify-center flex align-center pt-3 ">
    {{-- <input type="text" id="name" value="{{$key->first_name}} {{$key->last_name}} " class="editable-input text-xl font-bold text-center focus:outline-none border-none " readonly> --}}
      ...
      <div class="px-6 py-4">
          ...
          <div class="mt-4 space-y-2 p-6">
              ...
              <div class="flex justify-between align-center border-t pt-2 ">
                  ...
                  {{-- <span class="editable-input focus:outline-none flex-none text-right flex-grow pl-4">{{$key->user_id}}</span> --}}
              </div>

              <div class="flex justify-between align-center border-t pt-2">
                  <span class="font-medium ">Email ID:</span>
                  {{-- <input type="email" id="email" value="{{$key->email}}" class="editable-input focus:outline-none flex-none text-right flex-grow pl-4 " readonly> --}}
              ...
              <div class="flex justify-between border-t pt-2">
                  ...
                  {{-- <input type="text" id="name-input" value="{{$key->first_name}} {{$key->last_name}}" class="editable-input focus:outline-none flex-none text-right flex-grow pl-4" readonly> --}}
              </div>
              ...
              <div class="flex justify-between border-t pt-2">
                  ...
                  {{-- <input type="text" id="mobile" value="{{$key->phone}}" class="editable-input focus:outline-none flex-none text-right flex-grow pl-4" readonly> --}}
              </div>
              <div class="flex justify-between align-center border-t pt-2">
                  <span class="font-medium">Firm Name:</span>
                  <span class="editable-input focus:outline-none flex-none text-right flex-grow pl-4">Code Graphi Technologies Pvt. Ltd.</span>
              </div>
              <div class="flex justify-between align-center border-t pt-2">
                  <span class="font-medium">Date of Birth:</span>
                  {{-- <input type="date" id="dob" value="{{$key->dob}}" class="editable-input focus:outline-none flex-none text-right flex-grow pl-4 " readonly> --}}
              </div>

              <div class="flex space-x-96 border-t pt-2">
                  <span class="font-medium pr-20 ">Gender:</span>
                  <select id="gender" class="editable-input focus:outline-none  " disabled>
                      {{-- <option value="Male mr-20" selected>{{$key->gender}}</option> --}}
                      <option value="Female">Female</option>
                      <option value="Female">Other</option>
                  </select>
              </div>

              <div class="flex space-x-72 border-t pt-2">
                <span class="font-medium">Aadhar No:</span>
                {{-- <input type="text" id="aadhar" value="{{$key->aadhar_number}}" class="editable-input focus:outline-none flex-none text-right flex-grow pl-4" readonly> --}}
            </div>
              

              <div class="flex  justify-between  border-t pt-2">
                  <span class="font-medium">PAN No:</span>
                  {{-- <input type="text" id="pan" value="{{$key->pan_number}}" class="editable-input focus:outline-none flex-none text-right flex-grow pl-4" readonly> --}}
              </div>

              <div class="flex justify-between border-t pt-2">
                  <span class="font-medium">Address:</span>
                  <input type="text" id="address-input" value="Alphathum Bhutani, TOWER-S, Sector 90, Noida." class="editable-input focus:outline-none flex-none text-right flex-grow pl-4" readonly>
              </div>

              <div class="flex justify-between border-t pt-2">
                  <span class="font-medium">City:</span>
                  {{-- <input type="text" id="city" value="{{$key->city}}" class="editable-input focus:outline-none flex-none text-right flex-grow pl-4" readonly> --}}
              </div>

              <div class="flex justify-between border-t pt-2">
                  <span class="font-medium">State:</span>
                  {{-- <input type="text" id="state" value="{{$key->state}}" class="editable-input focus:outline-none flex-none text-right flex-grow pl-4" readonly> --}}
              </div>

              <div class="flex justify-between border-t pt-2">
                  <span class="font-medium">Pin Code:</span>
                  {{-- <input type="text" id="pin-code" value="{{$key->pin}}" class="editable-input focus:outline-none flex-none text-right flex-grow pl-4" readonly> --}}
              </div>
              {{-- @endforeach --}}
