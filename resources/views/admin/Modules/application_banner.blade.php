        ...
        <tbody>
          <tr class="border-b">
            ...
            <td class="px-4 py-3 h-5 w-5">
              <img src="{{asset('asset/img/gatewy1.png')}}" alt="">
            </td>
          ...
          <tr class="border-b">
            ...
            <td class="px-4 py-3">Login Carousel Image</td>
            <td class="px-4 py-3 h-5 w-5">
              <img src="{{asset('asset/img/gatewy2.png')}}" alt="">
            </td>
            <td class="px-4 py-3">05/05/2024</td>
            <td class="px-4 py-3">
              <button class="status-toggle w-12 h-6 rounded-full p-1 transition-colors duration-300 focus:outline-none bg-blue-900" onclick="toggleStatus(this)">
          ...
          <tr class="border-b">
            ...
            <td class="px-4 py-3 h-5 w-5">
              <img src="{{asset('asset/img/logo2.jpeg')}}" alt="">
            </td>
            <td class="px-4 py-3">05/05/2024</td>
            <td class="px-4 py-3">
              <button class="status-toggle w-12 h-6 rounded-full p-1 transition-colors duration-300 focus:outline-none bg-blue-900" onclick="toggleStatus(this)">
          ...
          <tr class="border-b">
            ...
            <td class="px-4 py-3 h-5 w-5">
              <img src="{{asset('asset/img/aadhar_pay.jpeg')}}" alt="">
            </td>
            <td class="px-4 py-3">05/05/2024</td>
            <td class="px-4 py-3">
              <button class="status-toggle w-12 h-6 rounded-full p-1 transition-colors duration-300 focus:outline-none bg-blue-900" onclick="toggleStatus(this)">
          ...
          <tr class="border-b">
            ...
            <td class="px-4 py-3 h-5 w-5">
              <img src="{{asset('asset/img/mobile_recharge.jpeg')}}" alt="">
            </td>
            <td class="px-4 py-3">05/05/2024</td>
            <td class="px-4 py-3">
              <button class="status-toggle w-12 h-6 rounded-full p-1 transition-colors duration-300 focus:outline-none bg-blue-900" onclick="toggleStatus(this)">
