...
<div class="main-container flex flex-col h-screen ">
  ...
  <aside id="sidebar" class="sidebar  fixed top-0 left-0 bg-white w-64 h-full shadow-lg transform -translate-x-full md:translate-x-0 transition-transform duration-300 overflow-y-auto  z-20">
    <div class="p-2 border-b-2 border-blue-900   sticky top-0 bg-white shadow-md p-4 z-10">
     <a href=""> <div class="flex justify-between items-center p-1 ">
    ...
    <nav class="mt-5">
      <a href="{{route('admin.admin_dashboard')}}" class="flex items-center px-4 py-4  font-medium  text-white bg-blue-900 mb-3 rounded-l-3xl">
        <span class="mr-3 ">
          <img src="{{asset('asset/img/Ehome1.png')}}" width="23" alt="home">
      ...
      <div class="relative">
        ...
        <a href="#" 
           ...
           id="kyc-btn">
          <span class="mr-3">
            <img src={{asset('asset/img/Ehome2.png')}} width="30px" height="30px" alt="kyc icon">
          </span>
          <span>Modules</span>
          <span class="ml-2">
        ...
        <div id="kyc-dropdown-menu" class="relative left-10 w-48 hidden">
          <a href="{{route('admin.servicereport')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">Service Category</a>
          <a href="{{route('admin.citymaster')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">City Master</a>
          <a href="{{route('admin.Usertypemaster')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">User Type Master</a>
          <a href="{{route('admin.service_master')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">Service Master</a>
          <a href="{{route('admin.plain_master')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">Plan Master</a>
      ...
      <a href="{{route('admin.company_bank')}}" class="flex items-center px-4 py-3 text-blue-900 font-medium  text-['#000b55'] hover:bg-blue-900 hover:text-white rounded-l-3xl ">
        <span class="mr-3">
            <img src="{{asset('asset/img/companybnk.png')}}" width="25px" height="25px" alt="service icon">
      ...
      <a href="{{route('admin.user_manager')}}" class="flex items-center px-4 py-3 text-blue-900 font-medium  text-['#000b55'] hover:bg-blue-900 hover:text-white rounded-l-3xl ">
        <span class="mr-3">
            <img src="{{asset('asset/img/usermnager.png')}}" width="30px" height="30px" alt="service icon">
        </span><span>Users Manager</span>
      </a>

      <a href="{{route('admin.companyhistry')}}" class="flex items-center px-4 py-3 text-blue-900 font-medium  text-['#000b55'] hover:bg-blue-900 hover:text-white rounded-l-3xl ">
        <span class="mr-3">
            <img src="{{asset('asset/img/accounthis.png')}}" width="28px" height="28px" alt="service icon">
        </span><span>Account History</span>
      </a>

      <a href="{{route('admin.fundrequest')}}" class="flex items-center px-4 py-3 text-blue-900 font-medium  text-['#000b55'] hover:bg-blue-900 hover:text-white rounded-l-3xl ">
        <span class="mr-3">
            <img src="{{asset('asset/img/fundre.png')}}" width="32px" height="32px" alt="service icon">
        </span><span>Fund Requests</span>
      </a>

      <a href="{{route('admin.payoutbnk')}}" class="flex items-center px-4 py-3 text-blue-900 font-medium  text-['#000b55'] hover:bg-blue-900 hover:text-white rounded-l-3xl ">
        <span class="mr-3">
            <img src="{{asset('asset/img/payoutbnk.png')}}" width="32px" height="32px" alt="service icon">
      ...
      <div class="relative">
        ...
        <a href="" 
          ...
          <span class="mr-3">
            <img src="{{asset('asset/img/fundtransfr.png')}}" width="32px" height="32px" alt="">
          </span>
        ...
        <div id="dropdown-menu" class="relative left-8  w-48 hidden">
          <a href="{{route('admin.fundtransfr')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">Fund Transfer</a>
          <a href="{{route('admin.allfundtrnsfr')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">All Fund Transfer</a>
      ...
      <div class="relative">
        <!-- Trigger -->
        <a href="{{route('admin.servicereport')}}" 
           class="flex items-center px-4 py-3 text-blue-900 font-medium hover:bg-blue-900 hover:text-white rounded-l-3xl"
           id="service-report-btn1">
          <span class="mr-3">
            <img src="{{asset('asset/img/accounthis.png')}}" width="28px" height="28px" alt="">
          </span>
        ...
        <div id="dropdown-menu1" class="relative left-8  w-48 hidden">
          <a href="{{route('admin.mobilerecharge')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">Mobile Recharge</a>
          <a href="{{route('admin.dthrechrage')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">Dth Recharge</a>
          <a href="{{route('admin.billpaymnt')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">Bill Payment</a>
          <a href="{{route('admin.adminaeps')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">Aeps</a>
          <a href="{{route('admin.menytransfr')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">Money Transfer</a>
          {{-- <a href="{{route('user.tds')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">Payout</a> --}}
          <a href="{{route('admin.fundrequest')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">Fund Request</a>
          <a href="{{route('admin.admnaddharpay')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">Aadhar Pay</a>
        </div>
      </div>
      ...
      <a href="{{route('admin.commisnslanadm')}}" class="flex items-center px-4 py-3 text-blue-900 font-medium  text-['#000b55'] hover:bg-blue-900 hover:text-white rounded-l-3xl ">
        <span class="mr-3">
            <img src="{{asset('asset/img/commisonslab.png')}}" width="30px" height="30px" alt="">
        </span><span>Commission Slab</span>
      </a>


      <a href="{{route('admin.gstadmn')}}" class="flex items-center px-4 py-3 text-blue-900 font-medium  text-['#000b55'] hover:bg-blue-900 hover:text-white rounded-l-3xl ">
        <span class="mr-3">
            <img src="{{asset('asset/img/gst.png')}}" width="30px" height="30px"  alt="home">
        </span><span>GST Report</span>
      </a>

      <a href="{{route('admin.tdsadm')}}" class="flex items-center px-4 py-3 text-blue-900 font-medium  text-['#000b55'] hover:bg-blue-900 hover:text-white rounded-l-3xl ">
        <span class="mr-3">
            <img src="{{asset('asset/img/tds.png')}}" width="30px" height="30px" alt="">
        </span><span>TDS Report</span>
      </a>


      <a href="{{route('admin.commsnreportadm')}}" class="flex items-center px-4 py-3 text-blue-900 font-medium  text-['#000b55'] hover:bg-blue-900 hover:text-white rounded-l-3xl ">
        <span class="mr-3">
            <img src="{{asset('asset/img/commisonslab.png')}}" width="28px" height="28px" alt="">
      ...
      <div class="relative">
        ...
        <a href="#" 
          ...
          <span class="mr-3">
            <img src="{{asset('asset/img/Ehome2.png')}}" width="25px" height="25px" alt="">
          </span>
        ...
        <div id="account-dropdown-menu1" class="relative left-10 w-48 hidden">
          <a href="{{route('admin.admnaddunds')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">Add Funds</a>
          <a href="{{route('admin.viewalladmn')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">View All</a>
      ...
      <div class="relative">
        ...
        <a href="#" 
          ...
          <span class="mr-3">
            <img src="{{asset('asset/img/setting.png')}}" width="30px" height="30px" alt="">
          </span>
        ...
        <div id="account-dropdown-menu" class="relative left-10 w-48 hidden">
          <a href="{{route('admin.changepassword')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-xl">Change Password</a>
  ...
  <div class="flex-1 ml-0 md:ml-64 ">
    ...
    {{-- <div class="flex-1 ml-0 md:ml-64"> --}}
        <header class="sticky top-0 z-4  bg-blue-900 text-white lg:py-4 py-2 lg:ml-2 flex justify-end align-center  rounded-xl ml-1 mr-1 lg:ml-1.5 lg:mr-1.5 ">
     ...
     <div class="lg:mr-1 mr-1 ml-3 text-white p-1 rounded-lg  font-normal lg:font-bold flex flex-row text-md ">
       <img src="{{asset('asset/img/wallet-6.png')}}" width="30px" height="5px" class="bg-blue-900 rounded-full lg:block hidden" alt="">
       <h3>Wallet: 2000</h3>
     </div>
     ...
     <div class="lg:mr-3 mr-1 text-white p-1 rounded-lg font-normal lg:font-bold text-md flex flex-row">
      ...
      <div class="mr-2 bg-white text-blue-900 lg:p-1.5 rounded-lg lg:px-3  font-semibold flex flex-row ml-1 ">
          <img src="{{asset('asset/img/notification-final.webp')}}" width="25px"  class="bg-blue-900 rounded-full lg:block hidden" alt="">
          <h3 class="ml-1 pl-1 pr-1  lg:block hidden">Notification</h3>
            ...
            <!-- Dropdown Menu -->
            <div id="dropdownMenu" class="absolute right-0 mt-2 mr-10 w-40 bg-white border rounded-lg shadow-lg flex flex-col align-center hidden">
              <a href="{{route('admin.admin_profile')}}" class="block px-4 py-2 text-medium text-blue-900 hover:bg-gray-200 rounded-lg">MY Profile</a>
              <a href="{{route('admin.admin_certificate')}}" class="block px-4 py-2 text-medium text-blue-900 hover:bg-gray-200 rounded-lg">Certificate</a>
