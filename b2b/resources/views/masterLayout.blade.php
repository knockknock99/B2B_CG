    ...
    <nav class="mt-3 ">
      ...
      <div class="relative">
        ...
        <a href="#" 
          ...
          <span class="mr-3">
            <img src="img/setting.png" width="27px" height="27px" alt="">
          </span>
    ...
    {{-- <div class="flex-1 ml-0 md:ml-64"> --}}
        <header class="bg-blue-900 text-white p-1.5 lg:p-4 ml-3 flex justify-between items-center sticky top-0 z-10 rounded-xl ml-1.5 mr-1.5">
          ...
          <div class="flex space-x-3">
            <div class="rounded-lg px-2 lg:px-4 lg:py-2 ml-1 bg-white text-blue-900 flex items-center  sm:py-1 ">
            ...
            <div class="rounded-lg px-4 py-2 bg-white text-green-500 flex items-center  ">
              <h1 class="text-sm font-normal lg:text-md lg:font-bold  lg:text-lg"><span class="text-blue-900">KYC Status: </span>Verified </h1>
              {{-- <span class="text-sm font-bold">₹ 0</span> --}}
          ...
          <div class="flex justify-center align-center ">
            ...
            <div class="mb mr-4">
              <h3 class="font-bold text-bold">Welcome, Md Jasim</h3>
            </div>
