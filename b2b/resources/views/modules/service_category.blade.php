...
<body class="font-sans ">
  ...
  <div class="p-6 bg-white mt-5 ml-4 mr-4 rounded">
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6  ">
      <h1 class="text-2xl font-semibold text-gray-800 mb-4 sm:mb-0">
        View All Service Categories
      </h1>

     <a href="{{route('admin.add_new_service_category')}}"> <div class="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
      ...
      <table class="w-full border-collapse">
        <thead>
          <tr class="bg-blue-900 text-white">
            ...
            <th class="px-4 py-3 text-left cursor-pointer">
              Service Category <i class="fas fa-arrow-up inline w-4 h-4"></i><i class="fas fa-arrow-down inline w-4 h-4"></i>
            </th>
        ...
        <tbody>
          <tr class="border-b">
            ...
            <td class="px-4 py-3">B2B SERVICES</td>
            <td class="px-4 py-3">
            ...
            <td class="px-4 py-3">27 Apr 2022 04:30 am</td>
            <td class="px-4 py-3">
          ...
          <tr class="border-b">
            ...
            <td class="px-4 py-3">ONLINE SERVICES</td>
            <td class="px-4 py-3">
              <button class="status-toggle w-12 h-6 rounded-full p-1 transition-colors duration-300 focus:outline-none bg-blue-900" onclick="toggleStatus(this)">
                <div class="status-indicator w-4 h-4 rounded-full bg-white translate-x-0"></div>
              </button>
            </td>
            <td class="px-4 py-3">27 Apr 2022 04:30 am</td>
            <td class="px-4 py-3">
