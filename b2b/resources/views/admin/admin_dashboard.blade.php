              ...
              <div id="statsCards" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                {{-- <div class="bg-green-200 p-3 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      <p class="font-semibold border-b-2 border-gray-700 text-gray-800">₹1,107.00</p>
                      <p class="text-sm text-gray-800 font-semibold">NSDL Pan Card Success</p>
                      <p class="font-semibold text-gray-700">0</p>
                    </div>
                  </div>
                </div> --}}
                ...
                {{-- <div class="bg-orange-200 p-3 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      <p class="font-semibold border-b-2 border-gray-700 text-gray-800">₹1,107.00</p>
                      <p class="text-sm text-gray-800 font-semibold">NSDL Pan Card Pending</p>
                      <p class="font-semibold text-gray-700">0</p>
                    </div>
                  </div>
                </div> --}}
                ...
                {{-- <div class="bg-red-200 p-3 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      <p class="font-semibold border-b-2 border-gray-700 text-gray-800">₹1,107.00</p>
                      <p class="text-sm text-gray-800 font-semibold">NSDL Pan Card Failed</p>
                      <p class="font-semibold text-gray-700">0</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="bg-green-200 p-3 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      <p class="font-semibold border-b-2 border-gray-700 text-gray-800">₹1,107.00</p>
                      <p class="text-sm text-gray-800 font-semibold">Money Transfer Success</p>
                      <p class="font-semibold text-gray-700">0</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="bg-orange-200 p-3 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      <p class="font-semibold border-b-2 border-gray-700 text-gray-800">₹1,107.00</p>
                      <p class="text-sm text-gray-800 font-semibold">Money Transfer Pending</p>
                      <p class="font-semibold text-gray-700">0</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="bg-red-200 p-3 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      <p class="font-semibold border-b-2 border-gray-700 text-gray-800">₹1,107.00</p>
                      <p class="text-sm text-gray-800 font-semibold">Money Transfer Failed</p>
                      <p class="font-semibold text-gray-700">0</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="bg-green-200 p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  <div class="flex items-center gap-3">
                    <div class="p-2 bg-blue-50 rounded-full"> --}}
                      {{-- <svg class="w-6 h-6"><use href="#smartphone-icon" /></svg> --}}
                      {{-- <img src="{{asset('img/atm.png')}}" width="25px" height="25px" alt="">
                    ...
                    <div>
                      <p class="font-semibold border-b-2 border-gray-700 text-gray-800">₹1,107.00</p>
                      <p class="text-sm text-gray-800 font-semibold">Fund Transfer Success</p>
                      <p class="font-semibold text-gray-700">0</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="bg-orange-200 p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      <p class="font-semibold border-b-2 border-gray-700 text-gray-800">₹1,107.00</p>
                      <p class="text-sm text-gray-800 font-semibold">Fund Transfer Pending</p>
                      <p class="font-semibold text-gray-700">0</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="bg-red-200 p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      <p class="font-semibold border-b-2 border-gray-700 text-gray-800">₹1,107.00</p>
                      <p class="text-sm text-gray-800 font-semibold">Fund Transfer Failed</p>
                      <p class="font-semibold text-gray-700">0</p>
                    </div>
                  </div>
                </div> --}}
                ...
                {{-- <div class="bg-green-200 p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      <p class="font-semibold border-b-2 border-gray-700 text-gray-800">₹1,107.00</p>
                      <p class="text-sm text-gray-800 font-semibold">UPI Collection Success</p>
                      <p class="font-semibold text-gray-700">0</p>
                    </div>
                  </div>
                </div> --}}
                ...
                {{-- <div class="bg-orange-200 p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      <p class="font-semibold border-b-2 border-gray-700 text-gray-800">₹1,107.00</p>
                      <p class="text-sm text-gray-800 font-semibold">UPI Collection Pending</p>
                      <p class="font-semibold text-gray-700">0</p>
                    </div>
                  </div>
                </div> --}}
                ...
                {{-- <div class="bg-red-200 p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      <p class="font-semibold border-b-2 border-gray-700 text-gray-800">₹1,107.00</p>
                      <p class="text-sm text-gray-800 font-semibold">UPI Collection Failed</p>
                      <p class="font-semibold text-gray-700">0</p>
                    </div>
                  </div>
                </div> --}}
                ...
                {{-- <div class="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow   ">
                  <div class="flex items-center gap-3  ">
                    ...
                    <div>
                      <p class="font-semibold text-gray-800 border-b-2 border-gray-800">₹1,107.00</p>
                      <p class="text-sm text-gray-800 ">Aeps Failed</p>
                      <p class="font-semibold text-gray-800">0</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow   border-l-8 border-green-700">
                  <div class="flex items-center gap-3  ">
                    ...
                    <div>
                      <p class="font-semibold text-gray-800 border-b-2 border-gray-800">₹1,107.00</p>
                      <p class="text-sm text-gray-800 ">Recharge Success</p>
                      <p class="font-semibold text-gray-800">0</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow   border-l-8 border-orange-600">
                  <div class="flex items-center gap-3 ">
                    ...
                    <div>
                      <p class="font-semibold text-gray-800 border-b-2 border-gray-800">₹1,107.00</p>
                      <p class="text-sm text-gray-800 ">Recharge Pending</p>
                      <p class="font-semibold text-gray-800">0</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow   border-l-8 border-red-500">
                  <div class="flex items-center gap-3  ">
                    ...
                    <div>
                      <p class="font-semibold text-gray-800 border-b-2 border-gray-800">₹1,107.00</p>
                      <p class="text-sm text-gray-800 ">Recharge Failed</p>
                      <p class="font-semibold text-gray-800">0</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow   border-l-8 border-green-700">
                  <div class="flex items-center gap-3  ">
                    <div class="p-2 bg-green-600 rounded-full"> --}}
                      {{-- <svg class="w-6 h-6"><use href="#smartphone-icon" /></svg> --}}
                      {{-- <img src="{{asset('img/atm.png')}}" width="25px" height="25px" alt="">
                    ...
                    <div>
                      <p class="font-semibold text-gray-800 border-b-2 border-gray-800">₹1,107.00</p>
                      <p class="text-sm text-gray-800 ">Aeps Success</p>
                      <p class="font-semibold text-gray-800">0</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow   border-l-8 border-orange-600">
                  <div class="flex items-center gap-3 ">
                    ...
                    <div>
                      <p class="font-semibold text-gray-800 border-b-2 border-gray-800">₹1,107.00</p>
                      <p class="text-sm text-gray-800 ">Aeps Pending</p>
                      <p class="font-semibold text-gray-800">0</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow   border-l-8 border-red-500">
                  <div class="flex items-center gap-3  ">
                    <div class="p-2 bg-red-500 rounded-full"> --}}
                      {{-- <svg class="w-6 h-6"><use href="#smartphone-icon" /></svg> --}}
                      {{-- <img src="{{asset('img/atm.png')}}" width="25px" height="25px" alt="">
                ...
                <div class="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow   border-b-8 border-green-700">
                  <div class="flex items-center gap-3  ">
                    <div class="p-2 bg-green-600 rounded-full"> --}}
                      {{-- <svg class="w-6 h-6"><use href="#smartphone-icon" /></svg> --}}
                      {{-- <img src="{{asset('img/commission_report.png')}}" width="25px" height="25px" alt="">
                ...
                <div class="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow   border-b-8 border-red-500">
                  <div class="flex items-center gap-3  ">
                    <div class="p-2 bg-red-500 rounded-full"> --}}
                      {{-- <svg class="w-6 h-6"><use href="#smartphone-icon" /></svg> --}}
                      {{-- <img src="{{asset('img/commission_report.png')}}" width="25px" height="25px" alt="">
